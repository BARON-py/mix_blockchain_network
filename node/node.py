...
class Node(threading.Thread):
    ...
    def save_connected_node(self,host,port):
        ...
        if not already_in_list:
         ...
         with open('connected_node.mix_blockchain_network', 'wb') as connected_node_file:
    ...
    def get_connected_node(self):
        try:
         ...
         old_cwd = os.getcwd()
         os.chdir(get_config().main_folder)
         with open('connected_node.mix_blockchain_network', 'rb') as connected_node_file:
    ...
    def connectionfrommix_blockchain_network(self):
        node_list = self.get_connected_node()
